    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://www.lucushost.com/blog/wp-content/uploads/2022/01/partes-de-una-pagina-web.png" class="d-block w-100" alt="">
            </div>
            <div class="carousel-item">
                <img src="https://www.mediasource.mx/hs-fs/hubfs/blog-files/fondos-web.jpg?width=950&name=fondos-web.jpg" class="d-block w-100" alt="">
            </div>
        </div>
    </div>
@stop
